...
.dragonice-nav .dropdown-menu .dropdown-item{
    ...
    <div class="fila">
        ...
        <ul class="nav-links" id="navLinks">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="dropdown-item" href="<?php echo $rutaMenu; ?>comentarios/formulario.php">
                            Comentarios
                        </a>
                    </li>
                </ul>
        ...
        <div class="iconos">
            ...
            <?php if (isset($_SESSION['rol'])) { ?>
                ...
                <?php } else { ?>
                    <a href="<?php echo $rutaMenu; ?>paginaprincipal/03.vendedor.php" class="icono-btn" aria-label="Mi panel">
                        <svg viewBox="0 0 24 24"><path d="M20 21v-1a7 7 0 0 0-14 0v1"></path><circle cx="13" cy="7" r="4"></circle></svg>
                    </a>
                <?php } ?>
