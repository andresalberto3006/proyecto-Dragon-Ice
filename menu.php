    ...
    <div class="fila"> 
        ...
        <div class="iconos"> 
            ...
            <a href="<?php echo $rutaMenu; ?>ubicacion.php" class="icono-btn" aria-label="Ubicación"> 
                <svg viewBox="0 0 24 24">
                    <path d="M12 21s-7-6.4-7-11a7 7 0 0 1 14 0c0 4.6-7 11-7 11z"></path>
            ...
            <?php if (isset($_SESSION['rol'])) { ?> 
                ...
                <?php if ($_SESSION['rol'] == 'Administrador') { ?> 
                    ...
                    <a href="<?php echo $rutaMenu; ?>paginaprincipal/02.admin.php" class="icono-btn" aria-label="Mi panel"> 
                        <svg viewBox="0 0 24 24">
                            <path d="M20 21v-1a7 7 0 0 0-14 0v1"></path>
            ...
            <?php if (!isset($_SESSION['rol']) || $_SESSION['rol'] != 'Administrador') { ?> 
                ...
                <!-- CAMBIO: ahora el carrito manda a pedidos/index.php -->

                <a href="<?php echo $rutaMenu; ?>carritoAjaxCliente/index.php" class="icono-btn" aria-label="Carrito de compras"> 
                    <svg viewBox="0 0 24 24">
                        <path d="M3 4h2l2.4 12.4a2 2 0 0 0 2 1.6h8.2a2 2 0 0 0 2-1.6L21 8H6"></path>
